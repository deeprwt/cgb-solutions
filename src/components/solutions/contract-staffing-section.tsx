...
// new icon
import icon_1011 from "@/assets/images/icon/icon_1011.png";
import icon_1012 from "@/assets/images/icon/icon_1012.png";
import icon_1013 from "@/assets/images/icon/icon_1013.png";
import icon_1014 from "@/assets/images/icon/icon_1014.png";
import icon_1015 from "@/assets/images/icon/icon_1015.png";
import icon_1016 from "@/assets/images/icon/icon_1016.png";
import icon_1017 from "@/assets/images/icon/icon_1017.png";
import icon_1018 from "@/assets/images/icon/icon_1018.png";
import icon_1019 from "@/assets/images/icon/icon_12.png";
import icon_1020 from "@/assets/images/icon/icon_1020.png";
            ...
            <div className="row">
              ...
              <div className="col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
                <div className="card-style-sixteen text-center position-relative mt-40">
                  <div className="m-auto tran3s rounded-circle d-flex align-items-center justify-content-center">
                    <Image src={icon_1014} alt="icon" className="lazy-img"  width={70} height={70}/>
                  </div>
