    ...
    <div className="contact-us-section pt-150 lg-pt-80">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <AddressBlock
                    icon={icon_2}
                    title="Contact Info"
                    subtitle='Drop a mail at :
                    <a href="mailto:info@cgbindia.com" className="call text-lg fw-500">info@cgbindia</a> <br />
                    Give us call at : <a href="tel:8287668958" className="call text-lg fw-500">8287668958</a>'
                  />
                </div>
      ...
      <div className="map-banner mt-120 lg-mt-80">
        <div className="gmap_canvas h-100 w-100">
          ...
          <iframe
           className="gmap_iframe h-100 w-100"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d979.4739631226944!2d77.6422128494832!3d12.892181344459578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae14bad2ab0221%3A0x8bd04d73b003661f!2sAKR%20Tech%20Park!5e0!3m2!1sen!2sin!4v1710137545208!5m2!1sen!2sin"  loading="lazy"></iframe>
          {/* <iframe
            className="gmap_iframe h-100 w-100"
